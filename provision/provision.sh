...
#! nix-shell -p bash opentofu docker
...
[ -f ./${ENV_PATH}/pre-provision.sh ] && source ${ENV_PATH}/pre-provision.sh
...
tofu -chdir=${ENV_PATH} apply -var-file="./../../variables.tfvars"
...
[ -f ./${ENV_PATH}/post-provision.sh ] && source ${ENV_PATH}/post-provision.sh
